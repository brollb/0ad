 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void Step(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Observation* response, std::function<void(::grpc::Status)>) = 0;
      virtual void Step(::grpc::ClientContext* context, const ::Actions* request, ::Observation* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      virtual void Step(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Observation* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      ...
      virtual void Reset(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Observation* response, std::function<void(::grpc::Status)>) = 0;
      virtual void Reset(::grpc::ClientContext* context, const ::ResetRequest* request, ::Observation* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      virtual void Reset(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Observation* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      ...
      virtual void GetTemplates(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Templates* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetTemplates(::grpc::ClientContext* context, const ::GetTemplateRequest* request, ::Templates* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      virtual void GetTemplates(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Templates* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
    };
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void Step(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Observation* response, std::function<void(::grpc::Status)>) override;
      void Step(::grpc::ClientContext* context, const ::Actions* request, ::Observation* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      void Step(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Observation* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void Reset(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Observation* response, std::function<void(::grpc::Status)>) override;
      void Reset(::grpc::ClientContext* context, const ::ResetRequest* request, ::Observation* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      void Reset(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Observation* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      ...
      void GetTemplates(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Templates* response, std::function<void(::grpc::Status)>) override;
      void GetTemplates(::grpc::ClientContext* context, const ::GetTemplateRequest* request, ::Templates* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      void GetTemplates(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Templates* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_Step : public BaseClass {
   ...
   public:
    ...
    void SetMessageAllocatorFor_Step(
        ::grpc::experimental::MessageAllocator< ::Actions, ::Observation>* allocator) {
      static_cast<::grpc::internal::CallbackUnaryHandler< ::Actions, ::Observation>*>(
  ...
  class ExperimentalWithCallbackMethod_Reset : public BaseClass {
   ...
   public:
    ...
    void SetMessageAllocatorFor_Reset(
        ::grpc::experimental::MessageAllocator< ::ResetRequest, ::Observation>* allocator) {
      static_cast<::grpc::internal::CallbackUnaryHandler< ::ResetRequest, ::Observation>*>(
  ...
  class ExperimentalWithCallbackMethod_GetTemplates : public BaseClass {
   ...
   public:
    ...
    void SetMessageAllocatorFor_GetTemplates(
        ::grpc::experimental::MessageAllocator< ::GetTemplateRequest, ::Templates>* allocator) {
      static_cast<::grpc::internal::CallbackUnaryHandler< ::GetTemplateRequest, ::Templates>*>(
